...
export class init1588117680953 implements MigrationInterface {
    name = 'init1588117680953'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ban" ("id" SERIAL NOT NULL, "detectedAt" TIMESTAMP NOT NULL, "preExisting" boolean NOT NULL, "type" "ban_type_enum" NOT NULL, "unbanned" boolean NOT NULL DEFAULT false, "unbannedAt" TIMESTAMP, "trackedAccountId" integer, CONSTRAINT "PK_071cddb7d5f18439fd992490618" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "ban" ADD CONSTRAINT "FK_5afebbd610cfe59e36bb590f147" FOREIGN KEY ("trackedAccountId") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
